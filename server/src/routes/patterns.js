...
const PATTERNS = [
  {
    ...
    severity: "high",
    description:
      "Making someone question their own reality, memory, or perception. This is one of the most damaging forms of emotional manipulation.",
    signs: [
      '"That never happened"',
    ...
    healthyAlternative:
      "In healthy relationships, both people's experiences and memories are respected, even during disagreements.",
  },
  {
    id: "love-bombing",
    name: "Love Bombing",
    ...
    severity: "medium",
    description:
      "Overwhelming someone with excessive affection, gifts, or attention early on to gain control and create emotional dependency.",
    signs: [
    ...
    healthyAlternative:
      "Healthy love builds gradually with mutual respect for boundaries and personal space.",
  },
  {
    id: "darvo",
    name: "DARVO",
    ...
    severity: "high",
    description:
      "Deny the behavior, Attack the person confronting them, Reverse the roles of Victim and Offender.",
    signs: [
    ...
    healthyAlternative:
      "In healthy relationships, people can accept responsibility for their actions without deflecting.",
  },
  {
    id: "isolation",
    name: "Isolation",
    ...
    severity: "high",
    description:
      "Gradually cutting someone off from their support network, friends, family, and other relationships.",
    signs: [
    ...
    healthyAlternative:
      "Healthy partners encourage you to maintain and grow your relationships with others.",
  },
  {
    id: "minimizing",
    name: "Minimizing",
    ...
    severity: "medium",
    description:
      "Downplaying someone's feelings, experiences, or concerns to make them seem unimportant.",
    signs: [
      '"It wasn\'t that bad"',
    ...
    healthyAlternative:
      "In healthy relationships, your feelings are acknowledged and validated, even when someone doesn't fully understand them.",
  },
  {
    id: "silent-treatment",
    ...
    severity: "medium",
    description:
      "Deliberately ignoring or refusing to communicate as a form of punishment or control.",
    signs: [
    ...
    healthyAlternative:
      "Healthy communication includes asking for space when needed while reassuring the other person you'll return to the conversation.",
  },
  {
    id: "guilt-tripping",
    name: "Guilt Tripping",
    ...
    severity: "medium",
    description:
      "Using guilt to manipulate someone into doing what you want or to make them feel bad about their choices.",
    signs: [
    ...
    healthyAlternative:
      "Healthy relationships involve expressing needs directly rather than using guilt as leverage.",
  },
  {
    id: "future-faking",
    name: "Future Faking",
    ...
    severity: "medium",
    description:
      "Making grand promises about the future with no real intention of following through, used to keep someone invested.",
    signs: [
    ...
    healthyAlternative:
      "Healthy partners follow through on commitments and address present issues rather than deflecting to future promises.",
  },
];
