...
export default function Layout() {
  ...
  return (
    ...
    >
      ...
      <main
        className={`flex justify-center px-4 py-6 md:py-10 relative z-10 transition-all duration-300 ${showConfirmLogout ? "blur-sm pointer-events-none" : ""}`}
      >
          ...
          >
            <div className="text-center">
              ...
              <h2
                ...
                style={{ fontFamily: "var(--font-serif)", color: "#3d2c2c" }}
              >
                Sign out?
              </h2>
              <p
                className="text-[#6b5454] text-sm mb-6"
